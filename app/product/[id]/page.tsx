                ...
                <div className="flex flex-wrap mb-24 -mx-4">
                    ...
                    <div className="w-full px-4 md:w-1/2">
                        <div className="lg:pl-20">
                            <div className="mb-6 ">
                                <span className="px-2.5 py-0.5 text-xs text-blue-600 bg-blue-100 dark:bg-gray-700 rounded-xl dark:text-gray-200">Seasonal Special</span>
                            ...
                            <div className="mb-6">
                                <h2 className="mb-2 text-lg font-bold text-gray-700 dark:text-gray-400">Dietary Information</h2>
                            ...
                            <div className="py-6 mb-6 border-t  border-gray-200 dark:border-gray-700">
                                ...
                                <p className="mt-2 text-sm text-blue-500 dark:text-blue-200">
                                    <span className="text-gray-600 dark:text-gray-400">
                                        The vegan curry is a delicious and healthy meal that is perfect for any occasion.
                                        It&apos;s made with fresh vegetables, coconut milk, and spices to create an authentic Indian flavor. This dish can be served as a main course or side dish. You can also add tofu or chicken if you want to make it more filling!
                                    </span>
                                </p>
                            </div>
