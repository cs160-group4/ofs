...
export default async function AdminPage() {
    ...
    let totalPayment = totalRevenue / 2;
            ...
            <div className="bg-gray-100 xl:h-screen dark:bg-gray-800">
                <div className="body-content" x-data="{ open: true }">
                    {/* <div className="relative lg:block navbar-menu">
                        <nav
                            // x-bind:className="! open ? 'w-0' : 'w-[280px]'"
                            className="fixed top-0 transition-all lg:mt-0 z-40 mt-16 left-0 dark:bg-gray-900 bottom-0 flex flex-col w-[280px] lg:border-none border-r border-gray-200 dark:border-gray-800 bg-gray-50 overflow-hidden "
                            id="sidenav">
                            ...
                            <div className="pb-6 mt-4 overflow-x-hidden overflow-y-auto ">
                                <ul className="mb-8 text-sm">
                                    ...
                                    <li x-data="false">
                                        <a href="#"
                                            // @click="open = ! open"
                                            className="open flex items-center px-8 py-4 text-gray-700 group dark:text-gray-400 dark:hover:bg-gray-700 hover:bg-gray-100">
                                            <span className="inline-block mr-3">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        {/* <div className="relative text-left lg:inline-block" x-data="{ open: false }">
                                            ...
                                            <div x-show="open" id="dropdown_profile"
                                                className="display-none absolute right-0 w-48 mt-3 origin-top-right bg-white rounded shadow dark:bg-gray-800 dark:text-gray-100 dark:bg-gray-700"
                                            >
                                                <div className="py-1">
                                                    <a href="#"
                                    ...
                                    <div className="flex flex-row items-center">
                                        <div className="flex-1 text-left md:text-left">
                                            <h2 className="mb-2 text-lg font-bold text-gray-600 uppercase dark:text-gray-400">
                                                Total orders</h2>
                                            <p className="mb-2 text-lg font-medium text-gray-600 dark:text-gray-400">{orders.length}</p>
                                ...
                                <div className="p-4 bg-white rounded-lg shadow hover:shadow-xl dark:bg-gray-900">
                                    <div className="flex flex-row items-center">
                                        <div className="flex-1 text-left md:text-left">
                                            <h2 className="mb-2 text-lg font-bold text-gray-600 uppercase dark:text-gray-400">
                                                Total Revenue</h2>
                                            <p className="mb-2 text-lg font-medium text-gray-600 dark:text-gray-400"> ${totalRevenue} </p>
                                ...
                                <div className="p-4 bg-white rounded-lg shadow hover:shadow-xl dark:bg-gray-900">
                                    <div className="flex flex-row items-center">
                                        <div className="flex-1 text-left md:text-left">
                                            <h2 className="mb-2 text-lg font-bold text-gray-600 uppercase dark:text-gray-400">
                                                Total Payment</h2>
                                            <p className="mb-2 text-lg font-medium text-gray-600 dark:text-gray-400"> ${totalPayment} </p>
                                ...
                                <div className="p-4 bg-white rounded-lg shadow hover:shadow-xl dark:bg-gray-900">
                                    <div className="flex flex-row items-center">
                                        <div className="flex-1 text-left md:text-left">
                                            <h2 className="mb-2 text-lg font-bold text-gray-600 uppercase dark:text-gray-400">
                                                Total Customers</h2>
                                            <p className="mb-2 text-lg font-medium text-gray-600 dark:text-gray-400">{customerCount}</p>
                            ...
                            <div className="grid grid-cols-1 gap-6 lg:grid-cols-3 ">
                                    ...
                                    <div className="px-4 py-3 text-xs font-medium">
                                        ...
                                        {/* <div className="flex justify-between p-4 mb-4 bg-gray-100 rounded dark:bg-gray-800">
                                            <div className="flex ">
                                                ...
                                                <div className="text-xs">
                                                    <p className="font-medium dark:text-gray-400">#889956795</p>
                                                    <p className="text-gray-500 dark:text-gray-400">John Lennon</p>
                                                </div>
                                            </div>
                                            <div className="flex">
                                        ...
                                        {/* <div className="flex justify-between p-4 mb-4 bg-gray-100 rounded dark:bg-gray-800">
                                            <div className="flex ">
                                                ...
                                                <div className="text-xs">
                                                    <p className="font-medium dark:text-gray-400">#889956794</p>
                                                    <p className="text-gray-500 dark:text-gray-400">Henry Ford</p>
                                                </div>
                                            </div>
                                            <div className="flex">
                                                <button className="mr-2 text-blue-600 dark:text-gray-400">
                                        ...
                                        <div className="flex justify-between p-4 mb-4 bg-gray-100 rounded dark:bg-gray-800">
                                            <div className="flex ">
                                                ...
                                                <div className="text-xs">
                                                    <p className="font-medium dark:text-gray-400">#889956793</p>
                                                    <p className="text-gray-500 dark:text-gray-400">Jimmy Hendrix</p>
                                                </div>
                                            </div>
                                            <div className="flex">
                                                <button className="mr-2 text-blue-600 dark:text-gray-400">
                                        ...
                                        <div className="flex justify-between p-4 mb-4 bg-gray-100 rounded dark:bg-gray-800">
                                            <div className="flex ">
                                                ...
                                                <div className="text-xs">
                                                    <p className="font-medium dark:text-gray-400">#889956792</p>
                                                    <p className="text-gray-500 dark:text-gray-400">Larry Page</p>
                                                </div>
                                            </div>
                                            <div className="flex">
                                                <button className="mr-2 text-blue-600 dark:text-gray-400">
                                        ...
                                        <div className="flex justify-between p-4 mb-4 bg-gray-100 rounded dark:bg-gray-800">
                                            <div className="flex ">
                                                ...
                                                <div className="text-xs">
                                                    <p className="font-medium dark:text-gray-400">#889956791</p>
                                                    <p className="text-gray-500 dark:text-gray-400">Anna Smith</p>
                                                </div>
                                            </div>
                                            <div className="flex">
                                                <button className="mr-2 text-blue-600 dark:text-gray-400">
                                ...
                                <div className="p-4 bg-white rounded-md shadow md:p-6 dark:bg-gray-900">
                                    ...
                                    {/* <div className="flex flex-wrap mb-6">
                                        ...
                                        <div className="flex-grow px-4">
                                            <a href="#" className="text-black ">
                                                <span className="mr-2 text-lg font-medium dark:text-gray-400">John Lennon</span>
                                    ...
                                    {/* <div className="flex flex-wrap ">
                                        ...
                                        <div className="flex-grow px-4">
                                            <a href="#" className="text-black ">
                                                <span className="mr-2 text-lg font-medium dark:text-gray-400">Anna Smith</span>
                                                <span className="font-normal text-gray-600 dark:text-gray-400">anna.smith@gmail.com</span>
                                            </a>
                                            <div className="flex items-center my-1 text-xs text-gray-600 dark:text-gray-400">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor" className="w-3 h-3 mr-2" viewBox="0 0 16 16">
                                            ...
                                            <div className="py-4 text-gray-600 dark:text-gray-400">
                                                The food is very delicious. I like it very much.
                                            </div>
                                            <div className="flex pt-2 text-sm border-t dark:border-gray-700">
                                                <a href="#"
                                                    className="flex items-center px-4 py-2 text-black no-underline dark:text-gray-400 ">
