import { Robot, getFilteredRobots } from "@/app/lib/robots";
...
export default async function RobotsTable({
    query,
    currentPage,
}: {
    query: string;
    ...
    let robots: Robot[] = await getFilteredRobots(query, currentPage);
    return (
        <>
                            ...
                            <tbody className="bg-white">
                                {robots?.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <td className="whitespace-nowrap px-3 py-3">
                                            {item.currentWeightInLbs} lbs
                                        </td>
                                        <td className="whitespace-nowrap px-3 py-3">
                                            {item.maxOrders}
                                        </td>
                                        <td className="whitespace-nowrap px-3 py-3">
                                            {item.maxWeightInLbs} lbs
                                        </td>
                                        <td className="whitespace-nowrap px-3 py-3">
