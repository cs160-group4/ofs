        ...
        <div>
            <form onSubmit={handleSubmit} >
                ...
                <div className="mb-4 lg:mb-7">
                    <input type="email" onChange={(e) => (email.current = e.target.value)} minLength={3} maxLength={320}
                        className="w-full px-4 py-4 bg-white rounded-lg lg:py-5 dark:text-gray-300 dark:bg-gray-700 "
                        name="email" placeholder="Enter your email" autoComplete="current-password" required />
                </div>
                <div className="mb-4 lg:mb-7">
                    <div className="relative flex items-center">
                        <input type={showPassword ? "text" : "password"} onChange={(e) => (pass.current = e.target.value)} minLength={6}
                            className="w-full px-4 py-4 bg-white rounded-lg lg:py-5 dark:text-gray-300 dark:bg-gray-700 "
                ...
                <button className="w-full hover:animate-pulse px-4 py-4 text-sm font-bold text-gray-300 uppercase bg-cyan-600 rounded-md lg:text-lg dark:text-gray-300 dark:bg-cyan-800 hover:bg-cyan-700 dark:hover:bg-cyan-900 "
                    type="submit">Sign In
                </button>
            </form >
        </div >
